/*******************************************************
 * 1) (REMOVIDO) CRIAÇÃO DE BOTÕES E ÁUDIO DE FUNDO
 *******************************************************/
...
// Se quiser manter o autoplay do seu iframe do Spotify (não oficial)
...
/*******************************************************
 * 3) FETCH DOS DADOS (SEUS customize.json)
 *******************************************************/
const fetchData = () => {
  fetch("customize.json")
    ...
    .then(data => {
      ...
      dataArr.forEach(customData => {
        ...
        // Quando acabar de iterar, inicia timeline
...
/*******************************************************
 * 4) TIMELINE DE ANIMAÇÕES GSAP
 *******************************************************/
const animationTimeline = () => {
  // Divide chars que precisam aparecer separadamente
  ...
  tl
    ...
    // Dispara confetes depois que a frase "wish h5" aparece
    .call(fireConfetti, null, "party+=0.5")
